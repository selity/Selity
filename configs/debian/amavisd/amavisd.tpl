...
$X_HEADER_LINE = "Selity MailStorm at $myhostname";  # after-default
...
@local_domains_maps = (read_hash("/etc/selity/amavisd/working/amavisd.domains"));
...
@score_sender_maps = (
	{   # a by-recipient hash lookup table,
		...
		'.' => [  # the _first_ matching sender determines the score boost
			...
			read_hash("/etc/selity/amavisd/working/sender_scores_sitewide"),
