...
LogFormat "%v %h %l %u %t \"%r\" %>s %b \"%{Referer}i\" \"%{User-Agent}i\" %I %O" selitylog

CustomLog "{PIPE}{ROOT_DIR}/engine/selity-apache-logger" selitylog
ErrorLog "{PIPE}{ROOT_DIR}/engine/selity-apache-logger -t error"
