...
$tpl->assign(
			array(
				'TR_PAGE_TITLE' => tr('Selity - Admin/Edit Domain'),
...
';
	...
	$domain_name = $data['admin_name'];
	$domain_ip_id = $data['user_ips'];
	$php_sup = $data['php'];
	$cgi_supp = $data['cgi'];
