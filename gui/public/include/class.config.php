...
final class Config {
	...
	private static $_values = array(
		...
		//'FTP_HOMEDIR' => null,
		//'IPS_LOGO_PATH' => null,
		'SELITY_SUPPORT_SYSTEM_PATH' => '',
		'SELITY_SUPPORT_SYSTEM_TARGET' => '',
		//'MYSQL_PREFIX' => null,
	...
	public static function load($cfg = '/etc/selity/selity.conf') {
		self::$_file = $cfg;

		if (!self::_parseFile())
			throw new Exception('Cannot open the selity.conf config file!');
