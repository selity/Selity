...
function register_user($uname, $upass) {
	...
	$udata = get_userdata($uname);
  	...
  	if ((Config::get('MAINTENANCEMODE') || databaseUpdate::getInstance()->checkUpdateExists()) && $udata['admin_type'] != 'admin') {
...
';
	...
	if ((Config::get('MAINTENANCEMODE') || databaseUpdate::getInstance()->checkUpdateExists()) && $user_type != 'admin') {
