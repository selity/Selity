...
// false = disable, true = enable
Config::set('SELITY_SUPPORT_SYSTEM', true);
...
//Config::set('SERVER_VHOST_FILE', Config::get('APACHE_SITES_DIR') . '/selity.conf');
...
require_once(INCLUDEPATH . '/selity-functions.php');
...
require_once(INCLUDEPATH . '/class.selity-update.php');
