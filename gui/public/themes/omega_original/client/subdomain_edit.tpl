			  ...
			  <tr>
				<td align="left"><table width="100%" cellpadding="5" cellspacing="5">
					<tr>
					  ...
					  <td colspan="2" class="title">{TR_MANAGE_SUBDOMAIN}</td>
					</tr>
				</table></td>
				<td width="27" align="right">&nbsp;</td>
			  </tr>
			  <tr>
				<td><form name="edit_alias_frm" method="post" action="subdomain_edit.php?edit_id={ID}">
					<table width="100%" cellpadding="5" cellspacing="5">
					  <tr>
						<td width="25">&nbsp;</td>
						<td colspan="2" class="content3"><b>{TR_EDIT_SUBDOMAIN}</b></td>
					  </tr>
					  <!-- BDP: page_message -->
					  <tr>
						<td>&nbsp;</td>
					  ...
					  <tr>
						<td width="25">&nbsp;</td>
						<td class="content2">{TR_SUBDOMAIN_IP}</td>
					  ...
					  <tr>
						...
						<td class="content"><input name="forward" type="text" class="textinput" id="forward" style="width:210px" value="{FORWARD}" {READONLY_FORWARD}></td>
					  </tr>
					  <tr>
						<td width="25">&nbsp;</td>
