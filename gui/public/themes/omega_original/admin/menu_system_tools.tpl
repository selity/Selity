<table style="width:100%;height:100%;border-collapse: collapse;padding:0;margin:0;">
 ...
 <tr>
  <td style="width: 100%; background-image: url({THEME_COLOR_PATH}/images/top/menu_bg.jpg); vertical-align: top;">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
	 <td><a href="selity_updates.php" class="submenu">{TR_MENU_SELITY_UPDATE}</a></td>
	</tr>
	<tr>
	 <td height="3" width="193"><img src="{THEME_COLOR_PATH}/images/top/menu_separator.jpg" height="3" width="193" /></td>
	</tr>
	<tr>
	 <td><a href="database_update.php" class="submenu">{TR_MENU_SELITY_DATABASE_UPDATE}</a></td>
	</tr>
	<tr>
	 <td height="3" width="193"><img src="{THEME_COLOR_PATH}/images/top/menu_separator.jpg" height="3" width="193" /></td>
	</tr>
	<tr>
	 <td><a href="selity_debugger.php" class="submenu">{TR_MENU_SELITY_DEBUGGER}</a></td>
	</tr>
	<tr>
	 <td height="3" width="193"><img src="{THEME_COLOR_PATH}/images/top/menu_separator.jpg" height="3" width="193" /></td>
	</tr>
 ...
 <tr height="53" style="vertical-align: bottom;">
  <td class="bottom" align="center">Selity {VERSION}<br />build: {BUILDDATE}<br />{CODENAME}</td>
 </tr>
</table>
