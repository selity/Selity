<html>
 <head>
  ...
  <title>{TR_ADMIN_SELITY_DEBUGGER_PAGE_TITLE}</title>
		  ...
		  <td>
		   ...
		   <table width="100%" cellpadding="5" cellspacing="5">
			...
			<tr>
			 <td>&nbsp;</td>
			 <td class="{CONTENT}">
			  {TR_DOMAIN_NAME} - <a href="selity_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a><br />
		   ...
		   <table width="100%" cellpadding="5" cellspacing="5">
			...
			<tr>
			 <td>&nbsp;</td>
			 <td class="{CONTENT}">
			  {TR_ALIAS_NAME} - <a href="selity_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a><br />
		   ...
		   <table width="100%" cellpadding="5" cellspacing="5">
			...
			<tr>
			 <td>&nbsp;</td>
			 <td class="{CONTENT}">
			  {TR_SUBDOMAIN_NAME} - <a href="selity_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a><br />
		   ...
		   <table width="100%" cellpadding="5" cellspacing="5">
			...
			<tr>
			 <td>&nbsp;</td>
			 <td class="{CONTENT}">
			  {TR_SUBDOMAIN_ALIAS_NAME} - <a href="selity_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a><br />
		   ...
		   <table width="100%" cellpadding="5" cellspacing="5">
			...
			<tr>
			 <td>&nbsp;</td>
			 <td class="{CONTENT}">
			  {TR_MAIL_NAME} - <a href="selity_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a><br />
