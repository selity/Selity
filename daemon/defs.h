...
#define MSG_WELCOME_TXT	            "250 OK Selity Daemon v1.1 Welcomes You!\r\n"
#define MSG_DAEMON_VER          10002
#define MSG_DAEMON_VER_TXT          "Selity daemon v1.1 started!"
#define MSG_DAEMON_NAME         10003
#define MSG_DAEMON_NAME_TXT         "selity_daemon"
...
#define MSG_CONF_FILE_TXT           "Selity configuration file not found!"
#define MSG_MISSING_REG_DATA    10021
#define MSG_MISSING_REG_DATA_TXT    "Selity data cannot be found in the config file!"
